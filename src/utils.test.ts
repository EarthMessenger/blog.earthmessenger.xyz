...
`.trim();
  ...
  expect(extractDescription(blog)).toBe(
    "To be, or not to be To be, or not to be, this that is the : Whether 'tis nobler in the mind to suffer Or to take arms against a sea of troubles And…",
  );
});

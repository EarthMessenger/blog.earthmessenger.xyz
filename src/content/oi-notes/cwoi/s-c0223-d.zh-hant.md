...
假設對於 $i$，取到最小值的 $k$ 是 $p_i$，容易證得對於任意一個 $i \le j$，$p_i
\le p_j$。故我們可以分治解決。

字首前 $i$ 小的和可以用可持久化線段樹做。

[robinyqc: 拉平的分治演算法](https://robinyqc.cn/blogs/blogrepo/%E6%8B%89%E5%B9%
B3%E7%9A%84%E5%88%86%E6%B2%BB%E7%AE%97%E6%B3%95) 中，提到了一種通過更改分治順序
避免使用可持久化線段樹的做法。
